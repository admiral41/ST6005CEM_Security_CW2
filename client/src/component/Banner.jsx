    ...
    <div className="flex justify-center items-center max-w-7xl mx-auto pt-5 max-sm:flex-col max-sm:px-5 max-sm:gap-y-5">
      ...
      <div className="flex flex-col gap-y-5">
        ...
        <p className="text-xl font-bold text-gray-600">
          Send your files and photos <span className="uppercase text-blue-500">securely</span> with MyShare <span className="uppercase text-blue-500">anytime</span> and <span className="uppercase text-blue-500">anywhere</span> in the world.
        </p>
        <div className="flex max-sm:flex-col max-sm:gap-y-2">
          {/* Replace Clerk components with React Router Links */}
          <Link
            to="/signup"
          ...
          <Link
            to="/login"
            className="text-blue-500 bg-white border-2 border-blue-500 hover:bg-blue-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-14 py-3 text-center max-sm:w-full"
          >
            Login Now
          </Link>
          <Link
