...
const LandingFeatures = () => {
  return (
    <div className='text-center p-10 max-w-7xl mx-auto'>
        <h2 className='text-5xl font-bold mb-4 max-sm:text-3xl'>People use <span className='text-blue-500'>MyShare</span> for</h2>
        <p className='text-xl font-bold text-gray-600 max-sm:text-lg'>Send your files and photos <span className='text-blue-500 uppercase'>SECURELY</span> with MyShare <span className='text-blue-500 uppercase'>ANYTIME</span> and <span className='text-blue-500 uppercase'>ANYWHERE</span> in the world.</p>
